...
```
python SubtypeSpecificIsoforms_global.py [-h] -i /path/to/ESPRESSO/isoform/abundance/matrix -a /path/to/sample-subtype_match_table -t <number of worker threads> \
...
script arguments:
    ...
    -o /path/to/output/file                             path to tsv file generated by script summarizing all transcript isoforms 
                                                        prioritized as being subtype-specific
```
