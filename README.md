...
```
TODO:
- Explain how to generate an "isoform proportion matrix".
- What is a "sample-subtype match table"? At the very least, describe the contents of this table and show a snippet of what this table might look like. 
```
