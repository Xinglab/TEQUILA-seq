...
#### generate 4.* target genes' bedGraph sh ####
...
for each_sample in sample_list:
	cmd = 'python '+dire_path+'/Create_bedgraph_for_each_gene.py '+each_sample+' '+target_gene_ID+' '+CPM_inf_name+' '+CPM_cut_off+' '+object_path+' '+sample_bedgraph+'\n'
	outf.write(cmd)
	cmd_2 = 'ls --color=never '+object_path+'/target_genes/*'+target_gene_ID+'*.bed > '+object_path+'/Display_'+target_gene_ID+'_bed_list.txt\n'
	outf.write(cmd_2)
outf.close()
