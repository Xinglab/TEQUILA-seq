...
anno_gtf_inf_name = '/mnt/isilon/xing_lab/aspera/xuy/snakemake_ESPRESSO_reference/pipeline_test/scripts_example_figure/Gencode_converted_all_exon_annotation_v39.txt'
...
#sorted_tuple = sorted(ave_exp_dict.items(),key=lambda item:item[1], reverse=True)
#for (each_key,each_value) in sorted_tuple:
#	bed_graph_outf.write(out_str_dict[query_sample+'_'+each_key])
#bed_graph_outf.close()
